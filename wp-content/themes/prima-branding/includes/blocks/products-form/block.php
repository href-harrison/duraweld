...
$data = array(
	...
	'relationship_header' => get_field('relationship_header') ?? false,
	'products_relation' => get_field('products_relation') ?? false,
	'form_shortcode' => get_field('form_shortcode') ?? false,
	'block_scroller_id' => get_field('block_scroller_id') ?? false,
);
