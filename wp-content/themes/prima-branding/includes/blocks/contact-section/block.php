...
$data = array(
	...
	'address_header' => get_field('address_header') ?? false,
	'form_header' => get_field('form_header') ?? false,
	'address' => get_field('address') ?? false,
	'social_media_repeater' => get_field('social_media_repeater') ?? false,
	'form_shortcode' => get_field('form_shortcode') ?? false,
	'duraweld_icon' => get_field('duraweld_icon') ?? false,
	'duraweld_info' => get_field('duraweld_info') ?? false,
);
